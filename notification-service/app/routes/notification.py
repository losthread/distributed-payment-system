...
async def get_all_notifications(user_id: UUID = Depends(get_user_id)) -> list[NotificationResponse]:
  return await notification.get_all_notifications(user_id)
